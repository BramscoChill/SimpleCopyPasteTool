...
namespace SimpleCopyPasteTool.Core.HookManager
{
    /// <summary>
    ...
    public class GlobalEventProvider : Component
    {
        ...
        public KeyEventHandler CreateThrottledKeyEventHandler(
        ...
        public KeyEventHandler CreateDebounceKeyEventHandler(
            KeyEventHandler handler,
            TimeSpan throttle)
        {
            var last = 0;
            return (s, e) =>
            {
                ...
                Task.Delay(throttle).ContinueWith(task =>
                {

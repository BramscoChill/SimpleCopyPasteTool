...
using SimpleCopyPasteTool.Core.WindowsInput.Native;

namespace SimpleCopyPasteTool.Core.WindowsInput
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Dispatches the specified list of <see cref="Native.INPUT"/> messages in their specified order by issuing a single called to <see cref="System.Runtime.InteropServices.NativeMethods.SendInput"/>.
        /// </summary>
        /// <param name="inputs">The list of <see cref="Native.INPUT"/> messages to be dispatched.</param>

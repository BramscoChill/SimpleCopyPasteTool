...
namespace SimpleCopyPasteTool.Core.WindowsInput
{
    ...
    public class InputSimulator : IInputSimulator
    {
        ...
        private InputSimulator(IKeyboardSimulator keyboardSimulator, IMouseSimulator mouseSimulator, IInputDeviceStateAdaptor inputDeviceStateAdaptor)
        {
